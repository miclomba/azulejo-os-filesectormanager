...
void log_fsm(FSM* _fsm, int _case, unsigned int _startByte) {
    ...
    switch (_case) {
        ...
        case 16:
            snprintf(msg, sizeof(msg), "Could not find %d contiguous inodes.", _fsm->contInodes);
            print_message(msg);
            break;
        ...
        case 22:
            snprintf(msg, sizeof(msg), "//Create a file\n//C:0\n\nCreated a file...");
            print_message(msg);
            break;
        // Print opened file
        case 23:
            snprintf(msg, sizeof(msg), "//Open a file\n//O:%d\n\nOpenned file at inode %d...\n",
                     _fsm->inodeNum, _fsm->inodeNum);
            print_message(msg);
            break;
        // Print write to file
        case 24:
            snprintf(msg, sizeof(msg), "//Write to file\n//W:%d\n\nWrote to file at inode %d...",
                     _fsm->inodeNum, _fsm->inodeNum);
            print_message(msg);
            break;
        // Print read from file
        case 25:
            snprintf(msg, sizeof(msg), "//Read from file\n//R:%d\n\nRead from file at inode %d..",
                     _fsm->inodeNum, _fsm->inodeNum);
            print_message(msg);
            break;
        // Print create directory
        case 26:
            snprintf(msg, sizeof(msg), "//Create a directory\n//C:1\n\nCreated a directory...");
            print_message(msg);
            break;
        // Print testing root
        case 27:
...
void log_ssm(SSM* _ssm, int _case, int _startByte) {
    ...
    switch (_case) {
        ...
        case 10:
            ...
            break;
        case 11:
            snprintf(msg, sizeof(msg), "The memory sectors are %f percent fragmented.\n",
                     _ssm->fragmented);
            print_message(msg);
            break;
        case 12:
        ...
        case 15:
            ...
            break;
        case 16:
            snprintf(msg, sizeof(msg), "Could not find %d contiguous sectors.\n",
                     _ssm->contSectors);
            print_message(msg);
            break;
        case 17:
