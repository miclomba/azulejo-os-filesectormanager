				...
				unsigned int _diskOffset)
{
	...
	/*sampleCount =*/fwrite(buffer, sizeof(unsigned int), _count * 32, _fileStream);

	// move to the beginning of the disk file
	fseek(_fileStream, 0, SEEK_SET);

} // end makeInodes(unsigned int _count, FILE *_fileStream,
  //						       unsigned int _diskOffset)
...
void readInode(Inode *_inode, unsigned int _inodeNum, FILE *_fileStream)
{
	...
	/*sampleCount =*/fread(buffer, sizeof(unsigned int), 20, _fileStream);
...
} // end readInode(Inode *_inode, unsigned int _inodeNum, FILE *_fileStream)
...
void writeInode(Inode *_inode, unsigned int _inodeNum, FILE *_fileStream)
{
	...
	/*sampleCount =*/fwrite(buffer, sizeof(unsigned int), 20, _fileStream);

	// move to the start of the filestream
	fseek(_fileStream, 0, SEEK_SET);

} // end writeInode(Inode *_inode, unsigned int _inodeNum, FILE *_fileStream)
