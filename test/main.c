 ...
 * @return void
 */
static void process_input(int argc, char** argv, char* input) {
 ...
 * @return void
 */
static void process_input_stub(char* input) {
